import 'package:hello_world/src/resources/change_password_page.dart';
import 'package:hello_world/src/resources/home_page.dart';
import 'package:hello_world/src/resources/register_page.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  void _onLoginClick() {
    ...
    var authBloc = Provider.of(context).authBloc;
    if(email=="nguyenhailongmchb1@gmail.com"&&pass=="123456"){
      Navigator.push(
          context,
          MaterialPageRoute(
